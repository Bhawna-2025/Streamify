...
const notification = () => {
  ...
  const incomingRequests = friendRequests?.incommingFriendRequest || [];
  const acceptedRequests = friendRequests?.acceptedRequest || [];
  return (
    <div className="p-4 sm:p-8 lg:p-8">
      <div className="contianer mx-auto max-w-4xl space-y-8">
        ...
        {isLoading ? (
          <div className="flex justify-center py-12">
            <span className="loading loading-spinner laosding-lg"></span>
          </div>
        ) : (
          <>
            {/*Incomming request */}
              ...
              <section className="space-y-4">
                ...
                <div className="space-y-3">
                  {incomingRequests.map((request) => (
                    <div
                      key={request._id}
                      className="card bg-base-200 hover:shadow-sd transition-shadow"
                    >
            ...
            {acceptedRequests.length > 0 && (
              <section className="space-y-4">
                <h2 className="text-xl font-semibold flex items-center gap-2">
                  <BellIcon className="h-5 w-3 text-success" />
                  New Connections
                </h2>
                <div className="space-y-3">
